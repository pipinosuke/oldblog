...
description = "スタートアップ界隈では服でもお菓子でも、何かしらのブランドを立ち上げてのD2Cビジネスが一つのトレンドとなっています。個人的な考えとしてD2Cの台頭はSNSの普及によってマス的な興味関心が細分化されていった、かつ興味関心がフォロワーという形で定量的な評価が可能になったというマクロトレンドに伴うものと理解しています。D2Cに限らず基本的にはどのビジネスにおいてでもブランドの重要性を感じていたのでこの本を読んでみることにしました。"
tags = []
category = ["読書"]
image = ""
draft = true
...
## おまけ 〜単語の詳解〜 ()
耳慣れない単語が多く出てきたので、メモがてら詳しく解説します。
### ブランド知識
### ブランド・イメージ
### ブランド・アイデンティティ
### コンテクスト